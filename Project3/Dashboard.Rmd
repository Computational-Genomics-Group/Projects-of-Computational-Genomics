...
ft.clr.gmpr=gmpr.pipeline(FEATURE_TABLE)
...
#ancom.clr=ancom.pipeline(my.clr(FEATURE_TABLE),METADATA)
ancom.gmpr=ancom.pipeline(ft.gmpr,METADATA)
#ancom.gmpr.clr=ancom.pipeline(ft.gmpr.clr,METADATA)
ancom.clr.gmpr=ancom.pipeline(ft.clr.gmpr,METADATA)
#ancom.css=ancom.pipeline(ft.css,METADATA)
#ancom.clr.css=ancom.pipeline(ft.clr.css,METADATA)

sum(ancom.raw$out$detected_0.7)
sum(ancom.gmpr$out$detected_0.7)
sum(ancom.clr.gmpr$out$detected_0.7)
