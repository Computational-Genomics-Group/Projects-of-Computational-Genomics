...
#ancom.imp.css=ancom.pipeline(ft.imp.css,METADATA) # not working
ancom.raw=ancom.pipeline(FEATURE_TABLE,METADATA)
ancom.gmpr=ancom.pipeline(ft.gmpr,METADATA)
#ancom.css=ancom.pipeline(ceiling(ft.css),METADATA) # not working


sum(ancom.raw$out$detected_0.7)
sum(ancom.gmpr$out$detected_0.7)
#sum(ancom.css$out$detected_0.7) 
#sum(ancom.imp.css$out$detected_0.7)
